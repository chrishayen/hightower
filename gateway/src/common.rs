...
pub mod context {
    ...
    impl NamespacedKv {
        ...
        pub fn put_bytes(&self, key: &[u8], value: &[u8]) -> Result<(), ::kv::Error> {
        ...
        pub fn flush(&self) -> Result<(), ::kv::Error> {
            self.inner.flush()
        }
    ...
    fn bootstrap_default_user(context: &CommonContext) -> Result<(), ::kv::Error> {
